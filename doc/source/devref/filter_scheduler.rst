...
`gantt.scheduler.weights.all_weighers`, which selects the following weighers:
...
.. |RamWeigher| replace:: :class:`RamWeigher <gantt.scheduler.weights.all_weighers.RamWeigher>`
